...
function sendDataAjax() {
    $.ajax({
        type: "POST",
        url: "GestionarStock.aspx/ListarStock",
        data: {},
...
function updateDataAjax() {
    ...
    var obj = JSON.stringify({ id: JSON.stringify(data[0]), serial: $("#txtASerial").val() });

    $.ajax({
        type: "POST",
        url: "GestionarStock.aspx/ActualizarDatosStock",
        data: obj,
        dataType: "json",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
...
function deleteDataAjax(data) {
    ...
    $.ajax({
        type: "POST",
        url: "GestionarStock.aspx/EliminarDatosStock",
        data: obj,
        dataType: "json",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
