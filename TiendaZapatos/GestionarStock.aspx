<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="GestionarStock.aspx.cs" Inherits="TiendaZapatos.GestionarStock" ClientIDMode="Static" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <section class="content-header">
        <h1 style="text-align: center">REGISTRO STOCK</h1>
    </section>
            ...
            <div class="">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <asp:DropDownList ID="dropReferencia" runat="server"></asp:DropDownList>
